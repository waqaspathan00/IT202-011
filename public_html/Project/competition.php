...
<?php if (isset($_POST["id"])) {
    ...
    $expires = se($_POST, "expires", 0, false) + $duration;
    ...
    $cost_to_create = (int)se($_POST, "cost_to_create", 0, false);
    ...
    if ($isValid) {
        ...
        try {
            ...
            if ($comp_id > 0) {
                change_points($cost, "create-comp", get_user_id(), -1, "Created Competition #$comp_id");
